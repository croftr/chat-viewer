                                ...
                                <Markdown
                                    ...
                                    components={{
                                        blockquote: ({ node, ...props }) => {
                                            return (
                                                <blockquote className="bg-gray-100 border-l-4 border-gray-500 italic my-4 pl-4 md:pl-6 text-black rounded">
                                                    {props.children}
                                                </blockquote>
                                            );
                                        },
                                        strong: (props) => {
                                            ...
                                            return <span className="font-semibold text-blue-500" {...rest} />;
                                        }
                                    }}
                                >
                                    {messageSummary}
